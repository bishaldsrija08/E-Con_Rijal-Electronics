const { createProduct, deleteProductById, updateProductById } = require('../../../controllers/admin/product/productController');
const { getAllProducts, getProductById } = require('../../../controllers/global/globalController');
